...
#Warning Log
                        print >> sys.stderr, 'X found in CS translation, not worrying about for feature ' + fid 
                    else:
#Debug Log?
...
#Warning Log
        print >> sys.stderr, 'possible error loading featureset into the WS for ' + g
        print >> sys.stderr, e
    # this is completely untested
    except urllib2.URLError, e:
#Warning Log
