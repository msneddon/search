...
var populateContigLengthsAndBrowser = function(contigLengths) {
	...
	contigWidget = makeContigWidget("contigTrackContainer", 500, 100, {"contig": contigTuples[0][0],
																	   "onClickFunction": selectHighlight,
																	   "allowResize": true });

	$('#contigButtonContainer').html("<button onClick=\"contigWidget.moveLeftEnd();\">&lt;&lt;</button>\n" + 
            						 "<button onClick=\"contigWidget.moveLeftStep();\">&lt;-</button>\n" +
            						 "<button onClick=\"contigWidget.zoomIn();\">+</button>\n" +
            						 "<button onClick=\"contigWidget.zoomOut();\">-</button>\n" +
            						 "<button onClick=\"contigWidget.moveRightStep();\">-&gt;</button>\n" +
						             "<button onClick=\"contigWidget.moveRightEnd();\">&gt;&gt;</button>\n");
 ...
 * browser.
 */
var populateGenome = function(id) {
...
var makeContigDropdown = function(contigTuples, dropdownId, containerId, func) {
	var dropdownHTML =
		"<div class='span5'>Contig: <select id='" + dropdownId + "' align='center' onchange=\"" + func + "\"></select></div>";
